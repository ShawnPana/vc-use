...
#     """
#     Small helper base class to provide Pydantic v1/v2 compatible
#     dict/json helpers.
#     """
#     def to_dict(self):
#         # Pydantic v2
...
#     def __str__(self) -> str:
#         founders_str = "\n\n".join(str(founder) for founder in self.founders_info) or "N/A"
#         return (
...
#         bio="Tech enthusiast and product builder."
#     )

#     company = Company(
#         company_website="https://example.com",
#         company_bio="We build AI tools that help teams move faster.",
...
#     # Pretty print
#     print("poop")
#     for founder in company.founders_info:
#         print(founder)
#         print("-----")
...
#     print("\nAs JSON:")
#     print(company.to_json(indent=2))
